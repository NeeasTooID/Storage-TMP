...
// Simpan referensi ke fungsi console.log asli
const originalConsoleLog = console.log;

// Ganti fungsi console.log dengan fungsi kustom
console.log = function() {
    // Konversi argumen menjadi array
    const logs = Array.from(arguments);

    // Gabungkan semua argumen menjadi satu string
    const logMessage = logs.join(' ');

    // Kirim log ke Discord webhook
    kirimLogKeDiscord(logMessage);

    // Panggil fungsi console.log asli
    originalConsoleLog.apply(console, logs);
};

// Fungsi untuk mengirim log ke Discord webhook
function kirimLogKeDiscord(logMessage) {
    const webhookURL = 'https://discord.com/api/webhooks/1202986553362751508/ITqGD8_WGTbZuaECOoqIKsv5yZKxWMXHq1piXcs0Po4UFZMdmtEoscgr3HQ0_E5Il6PK'; // Gantilah dengan URL webhook Discord Anda
    ...
    .catch(error => console.error('Gagal mengirim log ke Discord:', error));
}